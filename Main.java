...
public class Main {
    ...
    /**
     * Kollar att de input användare matar in är heltal, annars behöver man mata in igen till det bli rätt
     * @return

    public static String errorControl(String answer) {
        Scanner in = new Scanner(System.in);
        boolean error = true;
...
/**System.out.println("Enter the value of the radius: ");
        String check= errorControl(in.next());
        int radius=Integer.parseInt(check);

        System.out.println("Enter the value of the height: ");
        String checkTwo= errorControl(in.next());
        int height = Integer.parseInt(checkTwo);
        double volume = volume(radius, height);
        System.out.format("The volume of a cylinder is: %1.2f", volume);
        System.out.println();
        System.out.println();
        meny();*/
